...
if __name__ == "__main__":
    ...
    ############################################################
    # Problem 3.1: Spam Classification
    ############################################################
    ...
    grader.addBasicPart('3.1.1a-0', test1_1a_0, 1)
    ...
    grader.addPart('3.1.1a-1', test1_1a_1, 1)

    ############################################################
    # -- 3.1.1b: Experiment with thresholds n and k
    grader.addManualPart('3.1.1b-0', 1)

    ############################################################
    # -- 32.1.2a: extractUnigramFeatures
    def test_1_2a():
    ...
    grader.addBasicPart('3.1.2a', test_1_2a, 2)

    ############################################################
    # -- 3.1.2b: WeightedClassifier.classify
    def test1_2b():
    ...
    grader.addBasicPart('3.1.2b', test1_2b, 2)

    ############################################################
    # -- 3.1.3a: learnWeightsFromPerceptron
    def test1_3a_0():
    ...
    grader.addBasicPart('3.1.3a-0', test1_3a_0, 0)
    ...
    grader.addPart('3.1.3a-1', test1_3a_1, 6, 45)

    ############################################################
    # -- 3.1.3b:  extractBigramFeatures
    def test_1_3b_0():
        sentence = "The quick dog chased the lazy fox over the brown fence"
    ...
    grader.addBasicPart('3.1.3b-0', test_1_3b_0, 2)


    ############################################################
    # -- 3.1.3c: Vary number of examples with bigram features
    grader.addManualPart('3.1.3c', 5)

    ############################################################
    # Problem 3.2: Sentiment Classification
    ############################################################
    # Load training examples
    ...
    grader.addManualPart('3.2a', 3)


    ############################################################
    # -- 2b: Vary number of iterations
    grader.addManualPart('3.2b', 5)

    ############################################################
    # Problem 3.3: Document Categorization
    ############################################################
    ...
    grader.addBasicPart('3.3a-0', test_3a_0, 9)

    ############################################################
    # -- 3b: Report accuracies for one-vs-all
    grader.addManualPart('3.3b-0', 3)
